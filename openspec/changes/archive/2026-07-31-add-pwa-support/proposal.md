...
- **App icons**: new 192×192 and 512×512 PNG icons (plus a maskable variant) generated from the board's existing brand mark (💰 avatar green, `#0E8F5F`) for the manifest's `icons` array — the existing favicon/apple-touch-icon set is unchanged and untouched.
